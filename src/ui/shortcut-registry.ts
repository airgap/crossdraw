...
function buildDefaultBindings(): ShortcutBinding[] {
  ...
  return [
    ...
    toolShortcut('tool.pixelLine', 'Pixel Line Tool', 'shift+l', 'pixel-line'),
    toolShortcut('tool.pixelRect', 'Pixel Rectangle Tool', 'shift+r', 'pixel-rect'),
    toolShortcut('tool.pixelEllipse', 'Pixel Ellipse Tool', 'shift+e', 'pixel-ellipse'),
    toolShortcut('tool.pixelErase', 'Pixel Erase Tool', 'shift+x', 'pixel-erase'),
